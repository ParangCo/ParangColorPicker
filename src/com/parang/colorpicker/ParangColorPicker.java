...
public class ParangColorPicker {
	...
	public ParangColorPicker(Context context, Boolean IsPersian, ParangColorPickerListener Listener) {
		View mView = LayoutInflater.from(context).inflate(R.layout.color_picker_dialog_layout, null);

		ParangColorPickerWidget = (ParangColorPickerWidget) mView.findViewById(R.id.ColorPicker);
		ParangColorPickerWidget.PersianMode(IsPersian);

		this.listener = Listener;

		dialog = new AlertDialog.Builder(context).setView(mView).setPositiveButton(context.getString(R.string.OK), new DialogInterface.OnClickListener() {
